...
LinkTemplate.innerHTML = `
  ...
  .link-container.background:hover {
    background-color: var(--color-light_f5f5f5-dark_121212-reverse);
    padding: 0px 8px;
  }
  ...
  .link-container.underline:hover {
    border-radius: 0px;
    border-bottom: 2px dashed var(--color-light_f5f5f5-dark_121212-reverse)
  }
  .link-container.underline:hover > * {
  ...
  .link-container:focus-visible {
    outline: none;
    padding: 0px 8px;
    border: 1px dashed var(--color-light_0055ff-dark_009aff); 
  }
