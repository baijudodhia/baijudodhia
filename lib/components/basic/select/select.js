...
import selectCssTemplate from "./select.css";
import selectHtmlTemplate from "./select.html";

class AppSelectComponent extends HTMLElement {
  constructor(
    props = {
      id: "select",
      appearance: "primary",
    ...
    basePath = "/components/base/select",
    templateHtml = selectHtmlTemplate,
    templateStyleUrls = [selectCssTemplate],
  ) {
    super();
    ...
    setComponentTemplate.call(
      ...
      () => {
        console.log("Initial setup for app-select failed!");
      },
    );
  }
...
customElements.define("app-select", AppSelectComponent);
